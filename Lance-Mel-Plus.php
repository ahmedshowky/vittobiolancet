...
<div class="container">
    <h1 id="title-of-milk-replacer">Lance-Mel Plus</h1>
    <p>Lance-Mel Plus is a high-quality, nutritionally balanced milk replacer for calves, formulated to provide double the concentration of essential nutrients. This milk replacer ensures optimal levels of proteins, fats, vitamins, and minerals, promoting robust growth, strong immune function, and overall health from birth through weaning.</p>
    <br>
    <br>
    ...
    <br>
        ...
        <br>
        <ul>
            <li>For Pre-Weaned Calves: Mix 125 grams of milk replacer powder with 1 liter of warm water (40-45°C).</li>
        </ul>
        <br>
